...
#[napi]
fn key_tap(#[napi(ts_arg_type = "KeyboardKey")] key: String, modifier: Option<Vec<String>>) {
...
#[napi]
fn key_down(#[napi(ts_arg_type = "KeyboardKey")] key: String, modifier: Option<Vec<String>>) {
  keyboard::keyboard().down(&key, modifier.as_deref());
}

#[napi]
fn key_up(#[napi(ts_arg_type = "KeyboardKey")] key: String, modifier: Option<Vec<String>>) {
